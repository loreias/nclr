...
$(function()
{
    ...
    switch (templateId){
        ...
        case "template-c-two-col":
            $('body').addClass('template-blog-two-col');
            break;            
...
$(function (){
    ...
    if( $('body.template-home').length ){
        ...
        var blocks = $('.teasercolNclrTeaserCol').find('.col-img-caption'); 

        sameHighBlocks(blocks);

        $( window ).resize(function() {

            console.log('resi');
            
            sameHighBlocks($('.teasercolNclrTeaserCol').find('.col-img-caption'));        

        });        

    }

    function sameHighBlocks (blocks){
